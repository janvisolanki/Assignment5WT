...
<body>
	<video autoplay muted loop class="myVideo">
  	<source src="come.mp4" type="video/mp4">
	</video>
    <div class="content">
	...
	<div class="formdiv">
		<form method="POST"><fieldset>
			<legend>
		<h1 class="headings">Registration Form</h1></legend>
	...
	if ($_SERVER["REQUEST_METHOD"]=="POST"){
		if (isset($_POST["FirstName"]) && isset($_POST["LastName"]) && isset($_POST["Email"]) && isset($_POST["Country"]) && isset($_POST["type"]) && isset($_POST["pwd"])){
			...
			if($fname!=' ' && $lname!=' ' && $email!=' ' && $country!=' ' && $work!=' ' && $pwd!=' '){
				...
				die;
				if(!$result){
					echo "<script>alert('Record inserted');document.location='assign5n.php'</script>";
				}
			}
		}
		else
